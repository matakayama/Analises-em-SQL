/* Crie uma instrução SQL que retorne a média de idade, número de filhos e grau de instrução dos funcionários cujo salário/hora estiver acima da média de todos os funcionários.
